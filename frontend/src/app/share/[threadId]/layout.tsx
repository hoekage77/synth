...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Xera',
    description: 'Replay this Agent conversation on Xera',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Xera';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Xera';
